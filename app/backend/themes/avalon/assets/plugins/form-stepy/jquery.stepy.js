  ...
  var methods = {
    init: function(settings) {
      return this.each(function() {
        ...
        self.steps  = that.children('div.fieldset');
      ...
      self.steps.delegate('input[type="text"], input[type="password"]', 'keypress', function(evt) {
        ...
        if (key == 13) {
          ...
          var buttons = $(this).closest('div.fieldset').find('.stepy-navigator');
      ...
      return $(this).each(function() {
        ...
        if (that.data('stepy')) {
          var steps = that.data('stepy', false).children('div.fieldset').css('display', '');
      ...
      var steps = that.children('div.fieldset');
      ...
      var self = this,
        step    = that.children('div.fieldset').eq(index),
        isValid    = true,
